    ...
    def shortlist(self,camera,thresh_angle):
        ...
        ---------
            ...
            filters : string array
                Array of candidate filters

            limmag : float array
                Array of candidate limiting magnitudes
        
        """

        #Field times, id's, ra's, dec's, filter, and limiting magnitudes
        t=camera.fieldMJD
...
#-----------------------------------------------------------------------------------------------
    ...
    #                opstr=opstr+"%10s " %(test)
                    ...
                    opstr=opstr+"%7.3f  " %(filtmag)
                    opstr=opstr+"%7.3f  " %(VH0)
                    opstr=opstr+"%-5s  " %(filters[i])
                    print(opstr)
                    count+=1
