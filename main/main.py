...
config = configparser.ConfigParser({'Make SPKs':'F','nDays':'4000','SPK step':'20','nbody':'F','Survey T0':'0','Field1':'1','nFields':'1000','Space':'F','n_Proc':'1','Threshold':'5','SPICE IK':'camera.ti','Object1':'1','nObjects':'1','Make SPKs':'T'})
config.read_file(open(inputfile))
...
if __name__ == '__main__':
    for n in range(nProc):
        ...
        numObjects = nPerProc[n]
        a=ss.asteroidlist(population_model, asteroidspks, firstObject, numObjects)
        alist.append(a)

#alist=[ss.asteroidlist(population_model, asteroidspks, object1 + j * nPerProc[0], nPerProc[j]) for j in range(len(nPerProc))]
